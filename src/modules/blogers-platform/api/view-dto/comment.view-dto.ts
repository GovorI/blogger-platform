...
export class CommentViewDto {
    ...
    static mapToView(comment: CommentDocument, currentUserId?: string | null, myStatus?: string): CommentViewDto {
        ...
        dto.likesInfo = {
            ...
            myStatus: (currentUserId ? (myStatus || 'None') : 'None') as 'Like' | 'Dislike' | 'None',
        };
        return dto;
    }
}