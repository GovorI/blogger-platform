...
export class LikeStatusComment extends BaseLikeStatus {
    ...
    static createInstance(dto: CreateLikeStatusCommentDto): LikeStatusCommentDocument {
...
export type LikeStatusCommentModelType = Model<LikeStatusComment> & typeof LikeStatusComment;